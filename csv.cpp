...
extern "C" {
#endif
/** Parser a new CSV file
 *
 * \param filePath
 * \param delimiter
 * \param firstLineIsHeader
 * \return CsvParser point
 *
 */

CsvParser* Csv::CsvParser_new(const char *filePath, const char *delimiter, int firstLineIsHeader)
{
...
CsvParser* Csv::CsvParser_new_from_string(const char *csvString, const char *delimiter, int firstLineIsHeader)
{
...
/** \brief free Csv file from memory
 *
 * \param CsvParser point
 * \return null
 *
 */


void Csv::CsvParser_destroy(CsvParser *csvParser)
{
    if (csvParser == NULL)
    {
        return;
...
/** \brief free Csv file rows from memory
 *
 * \param CsvParser point
 * \return null
 *
...
void Csv::CsvParser_destroy_row(CsvRow *csvRow)
{
    int i;
 ...
 *
 */
const CsvRow* Csv::CsvParser_getHeader(CsvParser *csvParser)
{
 ...
 *
 */
CsvRow* Csv::CsvParser_getRow(CsvParser *csvParser)
{
...
/** \brief get the row field num
 *
 * \param CsvRow point
 * \return num Of Filelds
 *
 */
int Csv::CsvParser_getNumFields(const CsvRow *csvRow)
{
    return csvRow->numOfFields_;
}
/** \brief get the row field data
 *
 * \param CsvRow point
 * \return fields data
 *
 */
const char **Csv::CsvParser_getFields(const CsvRow *csvRow)
{
 ...
 *
 */
CsvRow *Csv::_CsvParser_getRow(CsvParser *csvParser)
{
    int numRowRealloc = 0;
 ...
 *
 * \param delimiter
 * \return delimiter is accepted
 *
 */
int Csv::_CsvParser_delimiterIsAccepted(const char *delimiter)
{
...
void Csv::_CsvParser_setErrorMessage(CsvParser *csvParser, const char *errorMessage)
{
    if (csvParser->errMsg_ != NULL)
    {
        free(csvParser->errMsg_);
...
const char *Csv::CsvParser_getErrorMessage(CsvParser *csvParser)
{
